...
opponent_idle_image = pygame.image.load(get_asset_path("Mothman.png"))
opponent_attack_image = pygame.image.load(get_asset_path("Mothman_attack1.png"))
opponent_alt_attack_image = pygame.image.load(get_asset_path("Mothman_attack2.png"))
opponent_block_image = pygame.image.load(get_asset_path("Mothman_block.png"))
...
def run_level_eight():
    ...
    while True:
        ...
        screen.blit(font.render("MOTHMAN", True, WHITE), (500, 20))
