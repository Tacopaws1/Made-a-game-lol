...
opponent_idle_image = pygame.image.load(get_asset_path("Brobot.png"))
opponent_attack_image = pygame.image.load(get_asset_path("Brobot_attack1.png"))
opponent_alt_attack_image = pygame.image.load(get_asset_path("Brobot_attack2.png"))
opponent_block_image = pygame.image.load(get_asset_path("Brobot_block.png"))
...
def run_level_nine():
    ...
    while True:
        ...
        screen.blit(font.render("Brobot", True, WHITE), (500, 20))
