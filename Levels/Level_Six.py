...
def run_level_six():
    ...
    pygame.display.set_caption("Level 6 BOSS")
    ...
    opponent_idle_image_phase1 = pygame.image.load(get_asset_path("The_Creature.png"))
    opponent_idle_image_phase1 = pygame.transform.scale(opponent_idle_image_phase1, (300, 300))
    opponent_attack1_image_phase1 = pygame.image.load(get_asset_path("The_Creature_attack.png"))
    opponent_attack1_image_phase1 = pygame.transform.scale(opponent_attack1_image_phase1, (300, 300))
    opponent_attack2_image_phase1 = pygame.image.load(get_asset_path("The_Creature_attack2.png"))
    opponent_attack2_image_phase1 = pygame.transform.scale(opponent_attack2_image_phase1, (300, 300))
    opponent_block_image_phase1 = pygame.image.load(get_asset_path("The_Creature__block.png"))
    opponent_block_image_phase1 = pygame.transform.scale(opponent_block_image_phase1, (300, 300))

    opponent_idle_image_phase2 = pygame.image.load(get_asset_path("The_Creature_Feature.png"))
    opponent_idle_image_phase2 = pygame.transform.scale(opponent_idle_image_phase2, (300, 300))
    opponent_attack1_image_phase2 = pygame.image.load(get_asset_path("The_creature_blast.png"))
    opponent_attack1_image_phase2 = pygame.transform.scale(opponent_attack1_image_phase2, (300, 300))
    opponent_attack2_image_phase2 = pygame.image.load(get_asset_path("Creature2_attack2.png"))
    opponent_attack2_image_phase2 = pygame.transform.scale(opponent_attack2_image_phase2, (300, 300))
    opponent_block_image_phase2 = pygame.image.load(get_asset_path("Super_Creature_block.png"))
    opponent_block_image_phase2 = pygame.transform.scale(opponent_block_image_phase2, (300, 300))
    background_image = pygame.image.load(get_asset_path("backgroundlvl6.png"))
    background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))
    turn_based_background = pygame.image.load(get_asset_path("cavebackground.jpg"))
    ...
    # Draw the game screen (Obstacle phase)
        ...
        if game_state == "turn_based":
                ...
                # Names
                hero_name = "Hero"
                opponent_name_phase1 = "The Creature"
                opponent_name_phase2 = "The Featured Creature"
                ...
                while True:
                    ...
                    if game_state == "turn_based":
                        ...
                        if opponent_health <= opponent_total_health * 0.5 and opponent_phase == 1:
                            opponent_phase = 2
                        ...
                        pygame.draw.rect(screen, RED, (WIDTH - 350, 50, opponent_health * 3, 20))

                        # Display Hero's name above the health bar
                        hero_name_text = small_font.render(hero_name, True, BLACK)
                        screen.blit(hero_name_text, (50, 20))

                        # Display Opponent's name above the health bar
                        opponent_name_text = small_font.render(opponent_name, True, BLACK)
